...
needs the C<MIME::Parser> module available from CPAN (C<MIME-tools> in
F<modules/by-module/MIME/>, for instance on L<ftp://ftp.perl.org/>).  This
...
(configure will search for it in standard locations, but if you have
...
$Id: install.pod 10097 2016-11-04 22:19:07Z iulius $
